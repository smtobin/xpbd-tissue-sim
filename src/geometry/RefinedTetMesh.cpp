...
void RefinedTetMesh::refineElement(int element_index, int refinement_level)
{
    ...
    for (int level = 0; level < refinement_level; level++)
    {
        ...
        for (const auto& parent_element : parent_elements)
        {
            ...
            Vec4i elem1(parent_element.element[0], mid_verts[0], mid_verts[1], mid_verts[2]);
            Vec4i elem2(parent_element.element[1], mid_verts[0], mid_verts[3], mid_verts[4]);
            Vec4i elem3(parent_element.element[2], mid_verts[1], mid_verts[3], mid_verts[5]);
            Vec4i elem4(mid_verts[2], mid_verts[4], mid_verts[5], parent_element.element[3]);
    ...
    /** TODO: remove the element properly
     * 
     * 
     * 
     * 
