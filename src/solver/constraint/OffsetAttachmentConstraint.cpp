...
OffsetAttachmentConstraint::OffsetAttachmentConstraint(int v_ind, PositionReference::VecType* vec_ptr, Real m, const Vec3r* attached_pos_ptr, const Vec3r& attachment_offset)
...
#ifdef HAVE_CUDA
OffsetAttachmentConstraint::GPUConstraintType OffsetAttachmentConstraint::createGPUConstraint() const
{
