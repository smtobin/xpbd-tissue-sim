...
void CAOSimBridge::_setupTumorDetachedPublisher()
{
    ...
    _sim->addCallback(1.0/this->get_parameter("publish_rate_hz").as_double(), tumor_detached_callback, this->get_parameter("use_wall_time_for_publishing").as_bool());
}
