...
def generate_launch_description():
    ...
    tumor_mesh_filename_arg = DeclareLaunchArgument(
        'tumor_mesh_filename',
    ...
    trachea_mesh_filename_arg = DeclareLaunchArgument(
        'trachea_mesh_filename',
        default_value = TextSubstitution(text=''),
        description='The file path of the .stl file to use as the trachea rigid geometry.'
    )

    CTtoVBTranslation_arg = DeclareLaunchArgument(
        'CT_to_VB_translation',
        default_value = TextSubstitution(text='[0.110, 0.137, 0.075]'),
    ...
    sim_bridge_node = Node(
        ...
        arguments=[
            ...
            '--tumor-mesh-filename', LaunchConfiguration('tumor_mesh_filename'),
            '--trachea-mesh-filename', LaunchConfiguration('trachea_mesh_filename'),
    ...
    ld = LaunchDescription([
        config_file_arg,
        simulation_type_arg,
        tumor_mesh_filename_arg,
        trachea_mesh_filename_arg,
