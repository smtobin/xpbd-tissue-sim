...
parser.add_argument('-v', '--target-vertices', type=int, default=800, help='Target number of vertices in the final mesh. The final number will be below this number.')
parser.add_argument('-o', '--output', help='Output STL file (optional)')

def main():
    args = parser.parse_args()

    common.decimateToTargetNumberOfVertices(args.input, args.target_vertices, args.output)
    ...
    # while (ms.current_mesh().vertex_number() > args.target_vertices):
